...
if __name__ == "__main__":
    ...
    # # MODEL_NAME = 'MNIST_medium'       # Model created by generator
    # MODEL_NAME = 'MNIST_large'       # Model created by generator
    # WEIGHTS_FILENAME = f'{MODEL_NAME}.pth'
    ...
    # FOLDER_NAME = './CIFAR_Models'   # Folder created by generator
    # # MODEL_NAME = 'CIFAR_small'       # Model created by generator
    # # MODEL_NAME = 'CIFAR_medium'       # Model created by generator
    # MODEL_NAME = 'CIFAR_large'       # Model created by generator
    # WEIGHTS_FILENAME = f'{MODEL_NAME}.pth'
    # ARCH_FILENAME = f'{MODEL_NAME}_architecture.pt'
    # IMAGE_FILENAME = 'test_image_0.png' # Image created by generator

    # --- 1. DEFINE PATHS FOR A SINGLE TEST CASE ---
    FOLDER_NAME = './TinyImageNet_Models'   # Folder created by generator
    MODEL_NAME = 'TinyImageNet_small'       # Model created by generator
    # # MODEL_NAME = 'TinyImageNet_medium'       # Model created by generator
    # MODEL_NAME = 'TinyImageNet_large'       # Model created by generator
    WEIGHTS_FILENAME = f'{MODEL_NAME}.pth'
    ARCH_FILENAME = f'{MODEL_NAME}_architecture.pt'
    IMAGE_FILENAME = 'test_image_0.png' # Image created by generator
